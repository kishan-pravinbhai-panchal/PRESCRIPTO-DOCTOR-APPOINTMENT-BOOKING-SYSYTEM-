...
// API TO GET USER APPOINTMENTS FOR FRONTEND MY_APPOINTMENT PAGE
...
const cancelAppointment = async (req, res) => {
    try {
        ...
        if (appointmentData.userId !== userId) {
            return res.json({ success: false, message: "Unathorised Action" })
        }
...
// API TO MAKE PAYMENT ONLINE WITH HELP OF RAZORPAY
...
//             await appointmentModel.findByIdAndUpdate(orderInfo.recipt,{payment:true})
