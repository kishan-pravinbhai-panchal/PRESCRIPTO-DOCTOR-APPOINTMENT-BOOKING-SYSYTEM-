  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div>
          ...
          <textarea onChange={(e)=>setAbout(e.target.value)} value={about}  className='w-full px-4 pt-2 border rounded 'placeholder='Write About Doctor' rows={5} id=""></textarea>
        </div>

        <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full hover:bg-slate-900 '>Add Doctor</button> 
      </div>
    </form>
