...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-4 mb-5 border-b border-b-gray-400 '>
            ...
            <ul className='hidden md:flex items-center gap-5 font-medium className="py-1"'>
                <NavLink to="/">
            ...
            <div className='flex items-center gap-4'>
                {
                    token && userData ? <div className='flex items-center gap-2 group cursor-pointer relative'>
