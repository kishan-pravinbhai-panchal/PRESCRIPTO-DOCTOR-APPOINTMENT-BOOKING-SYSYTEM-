  ...
  return (
    <div>
      <div className='text-center text-2xl pt-10 text-gray-500'>
         <p className='font-medium'>ABOUT <span className='text-gray-800 font-semibold'>US</span></p>
      </div>
      ...
      <div className='text-xl my-4'>
        <p className='font-medium text-gray-500'>WHY <span className='text-gray-900 font-semibold'>CHOOSE US</span></p>
      </div>
